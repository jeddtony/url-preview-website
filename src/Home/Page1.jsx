...
import VueLogo from './logo/vuejs-logo.svg';
import JqueryLogo from './logo/jquery-logo.svg';
...
const featuresCN = [
  ...
  {
    title: 'jQuery',
    content: 'Love jQuery, you\'ll love this too',
    src: JqueryLogo,
    color: '#F5222D',
  ...
  render() {
    ...
    children = children.map((item, i) => (
      <QueueAnim
        ...
        type="bottom"
        leaveReverse
        delay={[i * 50, (children.length - 1 - i) * 50]}
        component="ul"
      >
        {item}
      </QueueAnim>
    ...
    return (
      <div className="home-page page1" >
        <div className="home-page-wrapper" id="page1-wrapper">
          ...
          <h2>Use <span>Url Previewer</span> with your favorite framework </h2>
